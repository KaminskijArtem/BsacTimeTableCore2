...
namespace BsacTimeTableCore2.Areas.Admin.Controllers
{
    ...
    public class SubjectTypesController : Controller
    {
        ...
        // GET: Admin/SubjectTypes
        public async Task<IActionResult> Index()
        {
            return View(await _context.SubjectTypes.ToListAsync());
        }

        // GET: Admin/SubjectTypes/Details/5
        ...
        // GET: Admin/SubjectTypes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admin/SubjectTypes/Create
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var subjectType = await _context.SubjectTypes.SingleOrDefaultAsync(m => m.Id == id);
            if (subjectType == null)
            {
                return NotFound();
            }
        ...
        // POST: Admin/SubjectTypes/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/SubjectTypes/Delete/5
        ...
        // POST: Admin/SubjectTypes/Delete/5
