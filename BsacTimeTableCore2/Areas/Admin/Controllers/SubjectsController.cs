...
namespace BsacTimeTableCore2.Areas.Admin.Controllers
{
    ...
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,EduLevel,AbnameSubject")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,EduLevel,AbnameSubject")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
